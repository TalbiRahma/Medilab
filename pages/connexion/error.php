            ...
            <div class="col-xl-4 col-lg-5 col-md-7 d-flex flex-column mx-lg-0 mx-auto">
              <div class="card card-plain">
                <div class="card-header pb-0 text-start">
                  <h4 class="font-weight-bolder">Ooups utilisateur non trouver!</h4>
                ...
                <div class="card-body">
                    ...
                    <div class="text-center">
                      <a href="connexion.html"  class="btn btn-lg btn-primary btn-lg w-100 mt-4 mb-0">Se connecter</a>
                    </div>
                ...
                <div class="card-footer text-center pt-0 px-lg-2 px-1">
                  <p class="mb-4 text-sm mx-auto">
                    ...
                    <a href="../inscription/inscription.html" class="text-primary text-gradient font-weight-bold">S'inscrire</a>
                  </p>
                </div>
              </div>
            </div>
