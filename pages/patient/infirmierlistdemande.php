...
$requete_demandes = "SELECT demandes.*, professionnels.* 
                    ...
                    AND professionnels.type_professionnel='infirmier'";
...
foreach ($demandes as $demande) {
    ...
    $requete_professionnel = "SELECT * FROM professionnels WHERE id_professionnel=$id_pro  AND type_professionnel='infirmier' " ;
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-white active" aria-current="page">infirmier liste demande</li>
          </ol>
          <h6 class="font-weight-bolder text-white mb-0">infirmier liste demande</h6>
        </nav>
                ...
                <table class="table align-items-center mb-0">
                  <thead>
                    <tr>
                      ...
                      <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Nom Infirmerie</th>
                  ...
                  <tbody>
                    ...
                    foreach($demandes as $index =>$d){
                      ...
                      echo '<tr>
                        ...
                        echo '
                          <p class="text-xs font-weight-bold mb-0">'.$pro['nom'].'</p>';
                        } 
                        echo '</div>
                        </td>
                        ...
                        <div class="d-flex flex-column justify-content-center">
                          <a href="infirmierdemandedetails.php?id='.$id.'" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Edit user">
                          Voir plus
                          </a>
                        </div>
                        </td>
