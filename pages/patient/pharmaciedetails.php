      ...
      <div class="container-fluid py-1">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 ps-2 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-white active" aria-current="page">pharmacie details</li>
          </ol>
          <h6 class="text-white font-weight-bolder ms-2">pharmacie details</h6>
        </nav>
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                    <label for="example-text-input" class="form-control-label">Nom de la pharmacie</label>
                    <p class="mb-0 font-weight-bold text-sm"><?php echo $pharmacie['nom']; ?></p>
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
                    <label for="example-text-input" class="form-control-label">Adresse e-mail</label>
                    <p class="mb-0 font-weight-bold text-sm"><?php echo $pharmacie['email']; ?></p>
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
                    <label for="example-text-input" class="form-control-label">Telephone</label>
                    <p class="mb-0 font-weight-bold text-sm"><?php echo $pharmacie['telephone']; ?></p>
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
                    <label for="example-text-input" class="form-control-label">Adresse</label>
                    <p class="mb-0 font-weight-bold text-sm"><?php echo $pharmacie['adresse']; ?></p>
                  </div>
                </div>
              </div>
